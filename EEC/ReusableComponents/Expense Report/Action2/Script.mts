...
'Validate user is redirected to  My expense report items listing page.And a message is prompt stating "Submitted" and a new expense report is created and the status is submitted.(Step 22)
...
Parameter("strExpenseTitle") = strTitle
