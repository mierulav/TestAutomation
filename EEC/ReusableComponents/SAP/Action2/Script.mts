...
SAPGuiSession("Session").SAPGuiWindow("Vendor Line Item Display").SAPGuiCheckBox("Special G/L transactions").Set "ON" @@ hightlight id_;_1_;_script infofile_;_ZIP::ssf3.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Vendor Line Item Display").SAPGuiCheckBox("Noted items").Set "ON" @@ hightlight id_;_2_;_script infofile_;_ZIP::ssf3.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Vendor Line Item Display").SAPGuiCheckBox("Parked items").Set "ON" @@ hightlight id_;_3_;_script infofile_;_ZIP::ssf3.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Vendor Line Item Display").SAPGuiCheckBox("Customer items").Set "ON" @@ hightlight id_;_4_;_script infofile_;_ZIP::ssf3.xml_;_
...
Dim TotalAmount
If SAPGuiSession("Session").SAPGuiWindow("Document Overview - Display Vendor Invoice").SAPGuiLabel("n2Amount-TotalNT").Exist Then
	TotalAmount = Replace(Trim(SAPGuiSession("Session").SAPGuiWindow("Document Overview - Display Vendor Invoice").SAPGuiLabel("n2Amount-TotalNT").GetROProperty("Content")), ",", "")
ElseIf SAPGuiSession("Session").SAPGuiWindow("Document Overview - Display Vendor Invoice").SAPGuiLabel("n3Amount-TotalNT").Exist Then
		TotalAmount = Replace(Trim(SAPGuiSession("Session").SAPGuiWindow("Document Overview - Display Vendor Invoice").SAPGuiLabel("n3Amount-TotalNT").GetROProperty("Content")), ",", "")
ElseIf SAPGuiSession("Session").SAPGuiWindow("Document Overview - Display Vendor Invoice").SAPGuiLabel("n4Amount-TotalNT").Exist Then
		TotalAmount = Replace(Trim(SAPGuiSession("Session").SAPGuiWindow("Document Overview - Display Vendor Invoice").SAPGuiLabel("n4Amount-TotalNT").GetROProperty("Content")), ",", "")
Else
	TotalAmount = Replace(Trim(SAPGuiSession("Session").SAPGuiWindow("Document Overview - Display Vendor Invoice").SAPGuiLabel("nAmount-TotalNT").GetROProperty("Content")), ",", "")
End If
...
Parameter("strOutputs") = GetVendorCode & "," & GetGLCodeExpense & "," & TotalAmount & "," & ExpenseAmount
