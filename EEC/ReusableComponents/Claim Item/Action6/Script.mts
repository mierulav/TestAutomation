...
arrRes = Array(False, False, False, False)
...
'Validate that tax percentage,tax amount and  checkbox stating tax is not applicable is not displayed.(Step 6)
If ClaimItem.ValidateClaimItemTaxFields = False Then
	Reporter.ReportEvent micPass, "Claim Item Tax fields are not displayed", "Pass"
	arrRes(0) = True
Else
	Reporter.ReportEvent micFail, "Claim Item Tax fields are not displayed", "Fail"
End If
...
If ClaimItem.ValidateLocalCurrencyConvertedAmount Then
	...
	arrRes(2) = True
Else
	Reporter.ReportEvent micPass, "Local conversion amount is correct", "Fail"
End If
