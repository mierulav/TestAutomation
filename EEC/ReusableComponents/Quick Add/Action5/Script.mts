...
'Validation Step 5
If ClaimItem.ValidateClaimItemFixedTaxFields Then
	Reporter.ReportEvent micPass, "Validation 5: Claim Item is fixed tax", "Pass"
Else
	Reporter.ReportEvent micFail, "Validation 5: Claim Item is fixed tax", "Fail"
	Parameter("bResult") = False
	ExitAction
End If
