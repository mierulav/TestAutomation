...
For i = 1 To .GetSheet("Entitlement").GetRowCount
	...
	If .Value(Initiate.GetCompanyCode, "Entitlement") = "F" or .Value(Initiate.GetCompanyCode, "Entitlement") = "V" Then
		...
		For j = 1 To .GetSheet("ExpenseData").GetRowCount
			...
			If .Value("ToTest", "ExpenseData") = "F" or .Value("ToTest", "ExpenseData") = "Y" Then
				...
				RunAction "Create Complete Claim (Fixed Tax) [Quick Add]", oneIteration, strVal, bResult, strAmount, strTaxAmount
